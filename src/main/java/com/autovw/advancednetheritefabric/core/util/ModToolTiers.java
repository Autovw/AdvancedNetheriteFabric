...
public enum ModToolTiers implements ToolMaterial {
    NETHERITE_IRON(4, 2281, 12.0F, 4.0F, 15, ModItems.NETHERITE_IRON_INGOT),
    NETHERITE_GOLD(4, 2313, 20.0F, 4.0F, 25, ModItems.NETHERITE_GOLD_INGOT),
    NETHERITE_EMERALD(4, 2651, 29.0F, 5.0F, 20, ModItems.NETHERITE_EMERALD_INGOT),
    NETHERITE_DIAMOND(4, 3092, 39.0F, 5.0F, 15, ModItems.NETHERITE_DIAMOND_INGOT);
